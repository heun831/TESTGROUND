...
public class RewardedInterstitialSingleLoadFragment
    extends AdFragment<FragmentRewardedInterstitialBinding> {
  // Default constructor required for fragment instantiation.
  public RewardedInterstitialSingleLoadFragment() {}
    ...
    RewardedInterstitialAd.load(
        ...
        new AdLoadCallback<RewardedInterstitialAd>() {
          ...
          public void onAdLoaded(@NonNull RewardedInterstitialAd rewardedInterstitialAd) {
            RewardedInterstitialSingleLoadFragment.this.rewardedInterstitialAd =
          ...
          public void onFinish() {
            ...
            getChildFragmentManager()
                .setFragmentResultListener(
                    ...
                    RewardedInterstitialSingleLoadFragment.this,
